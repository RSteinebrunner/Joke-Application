                        ...
                        <p class="help-block">Create a new login name</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">                
                                    ...
                                    <p class="help-block">Create a new password</p>            </div>        </div>         <div class="form-group">            
                                        ...
                                        <div class="form-group">            
                                            ...
                                            <div class-"col-md-4">            
                                                <button id="submit" name="submit" class="btn btn-primary">OK</button>            </div>        </div>    </form></body></html>